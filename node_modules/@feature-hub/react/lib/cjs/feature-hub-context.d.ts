...
type SomeRequired<T, K extends keyof T> = Pick<T, Exclude<keyof T, K>> & Required<Pick<T, K>>;
...
export type FeatureHubContextConsumerValue = SomeRequired<FeatureHubContextProviderValue, 'logger'>;
export declare const FeatureHubContext: React.Context<FeatureHubContextProviderValue | undefined>;
/**
 ...
 */
export declare const FeatureHubContextProvider: React.Provider<FeatureHubContextProviderValue | undefined>;
/**
