...
import { BaseFeatureAppContainerProps } from './internal/internal-feature-app-container';
...
export interface FeatureAppContainerProps<TFeatureApp, TFeatureServices extends FeatureServices = FeatureServices, TConfig = unknown> extends BaseFeatureAppContainerProps<TFeatureApp, TFeatureServices, TConfig> {
    /**
...
//# sourceMappingURL=feature-app-container.d.ts.map