...
describe('FeatureAppContainer', () => {
    ...
    it('throws an error when rendered without a FeatureHubContextProvider', () => {
        expect(() => TestRenderer.create(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition }))).toThrowError(new Error('No Feature Hub context was provided! There are two possible causes: 1.) No FeatureHubContextProvider was rendered in the React tree. 2.) A Feature App that renders itself a FeatureAppLoader or a FeatureAppContainer did not declare @feature-hub/react as an external package.'));
        expectConsoleErrorCalls(noErrorBoundaryConsoleErrorCalls);
    });
    const renderWithFeatureHubContext = (node, { customLogger = true, testRendererOptions, } = {}) => TestRenderer.create(React.createElement(FeatureHubContextProvider, { value: {
    ...
    it('calls the Feature App manager with the given featureAppDefinition, featureAppId, config, baseUrl, beforeCreate callback, and done callback', () => {
        ...
        renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppDefinition: mockFeatureAppDefinition, featureAppId: "testId", config: "testConfig", baseUrl: "/base", beforeCreate: mockBeforeCreate, done: mockDone }));
    ...
    describe('with a React Feature App', () => {
        ...
        it('renders the React element', () => {
            const testRenderer = renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition }));
...
`);
        ...
        describe('when children function is provided', () => {
            it('passes react node to children function', () => {
                ...
                const testRenderer = renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, children: children }));
        ...
        describe('when the Feature App renders another Feature App', () => {
                ...
                mockFeatureAppScope = {
                    featureApp: {
                        render: () => {
                            ...
                            return (React.createElement(FeatureAppContainer, { featureAppId: "childTestId", featureAppDefinition: mockFeatureAppDefinition }));
                        },
                    },
                    release: jest.fn(),
                };
            ...
            it('passes the parent Feature App descriptor to `createFeatureAppScope`', () => {
                const testRenderer = renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "parentTestId", featureAppName: "parentTestName", featureAppDefinition: mockFeatureAppDefinition }));
                expect(mockCreateFeatureAppScope.mock.calls).toEqual([
                    [
                        'parentTestId',
                        mockFeatureAppDefinition,
...
`);
        ...
        describe('when the Feature App throws in render', () => {
            ...
            describe('with onError provided', () => {
                it('calls onError with the error', () => {
                    ...
                    renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, onError: onError }));
                    expect(onError.mock.calls).toEqual([[mockError]]);
                });
                it('does not log the error', () => {
                    renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, onError: jest.fn() }));
                ...
                describe('when onError throws an error', () => {
                    ...
                    it('re-throws the error', () => {
                        expect(() => renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, onError: () => {
            ...
            describe('with a children function provided', () => {
                ...
                it('renders what the children function returns', () => {
                    const testRenderer = renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, children: () => 'Custom Error UI' }));
                ...
                it('renders what the children function returns if feature app definition is undefined', () => {
                    const testRenderer = renderWithFeatureHubContext(React.createElement(InternalFeatureAppContainer, { featureAppId: "testId", children: () => 'loading UI', logger: logger, featureAppManager: mockFeatureAppManager }));
                ...
                describe('when children throws an error', () => {
                    ...
                    it('re-throws the error', () => {
                        expect(() => renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, children: () => {
        ...
        describe('when unmounted', () => {
            ...
            describe('when the Feature App scope throws an error while being destroyed', () => {
                ...
                describe('with onError provided', () => {
                    it('calls onError with the error', () => {
                        const onError = jest.fn();
                        const testRenderer = renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, onError: onError }));
                        testRenderer.unmount();
                        expect(onError.mock.calls).toEqual([[mockError]]);
                    });
                    it('does not log the error', () => {
                        const testRenderer = renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, onError: jest.fn() }));
                        testRenderer.unmount();
                        expect(logger.error).not.toHaveBeenCalled();
                    });
                    describe('when onError throws an error', () => {
                        ...
                        it('re-throws the error', () => {
                            const testRenderer = renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, onError: () => {
                                    throw onErrorMockError;
                                } }));
        ...
        describe('when a feature app has a loading promise', () => {
            ...
            describe('when no children function is passed', () => {
                describe('when no feature app definition is passed', () => {
                    it('renders null', () => {
                        const testRenderer = renderWithFeatureHubContext(React.createElement(InternalFeatureAppContainer, { featureAppId: "testId", logger: logger, featureAppManager: mockFeatureAppManager }));
                    ...
                    describe('with onError', () => {
                        ...
                        describe('when onError throws an error', () => {
                            ...
                            it('throws the error in render', async () => {
                                ...
                                const testRenderer = renderWithFeatureHubContext(React.createElement(TestErrorBoundary, { handleError: handleError },
                                    React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, onError: () => {
                                            throw onErrorMockError;
                                        } })));
                                expectConsoleErrorCalls([]);
                                await rejectLoadingPromise(loadingPromiseMockError);
    ...
    describe('with a DOM Feature App', () => {
        ...
        describe('when a Feature App throws in attachTo', () => {
            ...
            it("doesn't throw an error", () => {
                expect(() => renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition }), { testRendererOptions: { createNodeMock: () => ({}) } })).not.toThrowError(mockError);
            });
            it('logs the error', () => {
                renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition }), { testRendererOptions: { createNodeMock: () => ({}) } });
                expect(logger.error.mock.calls).toEqual([[mockError]]);
            });
            describe('with an onError function provided', () => {
                it('calls the function with the error', () => {
                    const onError = jest.fn();
                    renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, onError: onError }), { testRendererOptions: { createNodeMock: () => ({}) } });
                    expect(onError.mock.calls).toEqual([[mockError]]);
                });
                describe('when onError throws an error', () => {
                    let onErrorMockError;
            ...
            describe('with a children function provided', () => {
                it('calls the function with the error', () => {
                    ...
                    renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, children: children }), { testRendererOptions: { createNodeMock: () => ({}) } });
                ...
                it('renders the result of the function', () => {
                    ...
                    const testRenderer = renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition, children: children }), { testRendererOptions: { createNodeMock: () => ({}) } });
                    expect(testRenderer.toJSON()).toBe(customErrorUI);
                });
            });
            describe('without a children function provided', () => {
                it('renders null', () => {
                    const testRenderer = renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition }), { testRendererOptions: { createNodeMock: () => ({}) } });
    ...
    describe('without a custom logger', () => {
        it('logs messages using the console', () => {
            ...
            renderWithFeatureHubContext(React.createElement(FeatureAppContainer, { featureAppId: "testId", featureAppDefinition: mockFeatureAppDefinition }), { customLogger: false });
