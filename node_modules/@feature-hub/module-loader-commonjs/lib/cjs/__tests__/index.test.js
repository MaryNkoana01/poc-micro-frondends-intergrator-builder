...
describe('loadCommonJsModule (on Node.js)', () => {
    ...
    `;
        const loadedModule = await (0, __1.loadCommonJsModule)(url);
...
describe('createCommonJsModuleLoader', () => {
    ...
    `;
        const loadCommonJsModuleWithExternals = (0, __1.createCommonJsModuleLoader)({ foo: () => 42 }, init);
