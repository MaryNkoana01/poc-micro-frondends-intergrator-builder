    ...
    describe('HistoryServiceV1 (on Node.js)', () => {
        ...
        beforeEach(() => {
            ...
            createHistoryServiceBinder = () => {
                const sharedHistoryService = (0, __1.defineHistoryService)((0, __1.createRootLocationTransformer)({ consumerPathsQueryParamName: root_location_helpers_1.consumerPathsQueryParamName }), { mode: 'static' }).create(mockEnv);
        ...
        describe('#createStaticHistory()', () => {
            ...
            let history1;
            let history2;
            const createHistories = (serverRequest) => {
            ...
            describe('when no server request is provided', () => {
                it('throws an error', () => {
                    expect(() => createHistories(undefined)).toThrowError(new Error('Static history can not be created without a server request.'));
                });
            });
            describe('when called multiple times for the same consumer', () => {
                it('returns the same instance and logs a warning', () => {
                    expect(historyBinding1.featureService.createStaticHistory()).toEqual(history1);
                    expect(stubbed_logger_1.stubbedLogger.warn).toHaveBeenCalledWith('createStaticHistory was called multiple times by consumer "test1". Returning the same history instance as before.');
                });
            });
            describe('#length', () => {
                it('always returns 1', () => {
            ...
            describe('#location', () => {
                ...
                it('retrieves consumer specific locations from the server request url', () => {
                    destroyHistories();
                    const serverRequest = {
                        url: (0, root_location_helpers_1.createUrl)({ test1: '/foo', test2: 'bar' }, { relative: true }),
                        cookies: {},
                        headers: {},
                    };
            ...
            describe('#push()', () => {
                it('changes the static root location for every consumer push', () => {
                    ...
                    expect(historyService1.staticRootLocation).toMatchObject({
                        search: (0, root_location_helpers_1.createSearch)({ test1: '/foo', test2: '/bar?baz=1' }),
                    });
                });
                ...
                it('handles relative pathnames', () => {
                    ...
                    history1.push('baz');
                    expect(historyService1.staticRootLocation).toMatchObject({
                        search: (0, root_location_helpers_1.createSearch)({ test1: '/foo/baz' }),
                    });
                });
            });
            describe('#replace()', () => {
            ...
            describe('#block()', () => {
                it('does nothing and logs a warning', () => {
                    ...
                    expect(historyService1.staticRootLocation).toMatchObject({
                        search: (0, root_location_helpers_1.createSearch)({ test1: '/foo?bar=1' }),
                    });
            ...
            describe('#listen()', () => {
                it('does nothing and logs a warning', () => {
                    ...
                    expect(stubbed_logger_1.stubbedLogger.warn).toHaveBeenCalledWith('history.listen() is not supported.');
                });
            ...
            describe('#createHref()', () => {
                it('returns the href for the given location based on the static root history', () => {
                    ...
                    expect(href).toBe((0, root_location_helpers_1.createUrl)({ test1: '/foo', test2: '/bar?a=b' }, { pathname: '/example', relative: true }));
                });
                it('normalizes the pathname', () => {
                    history1.push('/foo');
                    const location = { pathname: 'bar' };
                    const href = history2.createHref(location);
                    expect(href).toBe((0, root_location_helpers_1.createUrl)({ test1: '/foo', test2: '/bar' }, { pathname: '/example', relative: true }));
                });
            });
        });
        ...
        describe('#history', () => {
            ...
            describe('#location', () => {
                ...
                it('retrieves consumer specific locations from an absolute server request url', () => {
                    const serverRequest = {
                        url: (0, root_location_helpers_1.createUrl)({ test1: '/foo', test2: 'bar' }, { relative: false }),
                        cookies: {},
                        headers: {},
                    };
                    createHistories(serverRequest);
