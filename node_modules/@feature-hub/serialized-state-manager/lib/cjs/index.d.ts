import { FeatureServiceBinder, FeatureServiceProviderDefinition, SharedFeatureService } from '@feature-hub/core';
 ...
 */
export declare function defineSerializedStateManager(serializedStates?: string): FeatureServiceProviderDefinition<SharedSerializedStateManager>;
/**
 * @see [[defineSerializedStateManager]] for further information.
 */
export declare const serializedStateManagerDefinition: FeatureServiceProviderDefinition<SharedSerializedStateManager, import("@feature-hub/core").FeatureServices>;
