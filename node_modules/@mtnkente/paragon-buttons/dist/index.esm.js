...
import { boxShadow } from '@mtnkente/paragon-foundation';
import { Placeholder } from '@mtnkente/paragon-icons';
...
const StyledButtonIcon = /*#__PURE__*/styled.div.withConfig({
...
const StandardButton = /*#__PURE__*/React.forwardRef((props, ref) => {
  var _a;
  const {
      label,
      icon
  ...
  return jsxs(StyledButton, Object.assign({}, rest, {
    ...
    ref: ref,
    label: label,
    children: [icon && jsxs(StyledButtonIcon, {
      children: [" ", icon, " "]
    }), label]
  }));
});
...
const Icon = /*#__PURE__*/styled(Placeholder).withConfig({
...
const TextButton = props => {
  ...
  return jsxs(Base, Object.assign({}, rest, {
    "aria-label": (_a = props['aria-label']) !== null && _a !== void 0 ? _a : 'Text Button',
    children: [props.showIcon && jsx(Icon, {}), children]
  }));
};

export { StandardButton, TextButton };
